...
let me = [Name = "Marco", surname = "Zennaro", age = 36];
console.log(me);
...
function deleteOne(){
  if(c !=='true'){
    ...
    return stri.substring(0,3);
  }else{
    return stri.substring(1);
  }
}
...
*/
function css() {
  const myElement5 = document.querySelectorAll("tr");
  for (let i = 0; i < myElement5.length; i++) {
